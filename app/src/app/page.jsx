  ...
  return (
    <div className='min-h-screen fixed w-full bg-custom-blue flex flex-col'>
      ...
      <div className='z-50 mt-[50px]'>
        <h1 id='hr2' className='mt-[80px] flex ml-10 text-[35px] text-gray-300'>AQUA</h1>

        <p id='hr1' className='w-[260px] text-[14px] ml-10 mt-10 text-gray-300 mb-[-8px]'>
          Türkiye’nin en güzel su altı noktalarında, profesyonel rehberler eşliğinde unutulmaz bir yolculuğa çıkın.
        </p>
        <div id='hr1' className='flex justify-center items-start text-start'>
          <hr className='w-[230px] mb-[-15px] ml-5  ' />
        </div>
        <div id='hr2' className='flex justify-start items-start text-start'>
          <hr className='w-[200px] mb-[-15px] ml-8 ' />
        </div>
        <div id='hr3' className='flex justify-start items-start text-start'>
          <hr className='w-[150px] mb-[300px] ml-[30px] ' />
        </div>
        <div id='hr3' className=' flex justify-center items-center'>
          <button
